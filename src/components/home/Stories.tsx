...
export const Stories = () => {
  ...
  return (
    <>
      ...
      <div className="flex max-w-50 mx-auto text-center items-center gap-2 text-sm text-blue-800 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-1">
